    ...
    class Program
    {
        ...
        static void Seeding()
        {
            using (var context = new ApplicationDbContext())
            {
                ...
                {
                    userManager.CreateUser("admin@fonlow.com", "admin@fonlow.com", "Zzzzzz*8", RoleConstants.Admin);
                    userManager.CreateUser("api@fonlow.com", "api@fonlow.com", "Aaaaaa*8", RoleConstants.Api);
                }
